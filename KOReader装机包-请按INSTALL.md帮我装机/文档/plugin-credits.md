...
| 生僻字注音 pinyin | **zhouwt**（原作者）；拼音数据 © [mozillazg/pinyin-data](https://github.com/mozillazg/pinyin-data)（MIT）与 Unicode Unihan | KeZi 自改版 |
| KOAI（AI 伴读，DeepSeek） | [mufeng0199/KOAI-Reader](https://github.com/mufeng0199/KOAI-Reader)（原版 KOAI）与 [chunbo129/AIReadingAssistant](https://github.com/chunbo129/AIReadingAssistant) | KeZi 根据两者合并改进 |
| 锁屏壁纸 customisablesleepscreen | [pxlflux](https://github.com/pxlflux/customisablesleepscreen.koplugin) | KeZi 自改（书内书外双壁纸） |
