...
function VocabBuilder:registerDictButtons()
    ...
    self.ui.dictionary:addToDictButtons({
        ...
        -- conditional buttons are appended to extra_layout, which is always
        -- rendered, even when a saved dict_button_config layout exists
        -- (custom frontends may otherwise swallow newly registered buttons).
        conditional = true,
        row_group = "vocab_add",
        font_bold = false,
